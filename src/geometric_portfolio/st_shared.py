...
def show_leverage(returns: pd.Series, title: str | None = None, minimum_leverage: float = 0.0, maximum_leverage: float = 1.0):
    """
    ...
    """
    df = leverage_optimizer(returns, minimum_leverage=minimum_leverage, maximum_leverage=maximum_leverage)
